...
{
    internal class __QsRef0__MCMTMask__ : UDTBase<(Int64,Int64)>, IApplyData
    {
        public __QsRef0__MCMTMask__() : base(global::Microsoft.Quantum.Simulation.Core.Default.OfType<(Int64,Int64)>())
        {
        }

        public __QsRef0__MCMTMask__((Int64,Int64) data) : base(data)
        {
        }
    ...
    internal class __QsRef0__DecompositionState__ : UDTBase<(IQArray<Int64>,IQArray<(System.Numerics.BigInteger,Int64)>,IQArray<(System.Numerics.BigInteger,Int64)>)>, IApplyData
    {
        public __QsRef0__DecompositionState__() : base(global::Microsoft.Quantum.Simulation.Core.Default.OfType<(IQArray<Int64>,IQArray<(System.Numerics.BigInteger,Int64)>,IQArray<(System.Numerics.BigInteger,Int64)>)>())
        {
        }

        public __QsRef0__DecompositionState__((IQArray<Int64>,IQArray<(System.Numerics.BigInteger,Int64)>,IQArray<(System.Numerics.BigInteger,Int64)>) data) : base(data)
        {
        }
